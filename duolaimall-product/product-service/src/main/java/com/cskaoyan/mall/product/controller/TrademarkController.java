...
public class TrademarkController {
    ...
    public Result<TrademarkPageDTO> index(@PathVariable Long page,
    ...
    public Result<TrademarkDTO> get(@PathVariable Long id) {
    ...
    public Result updateById(@RequestBody TrademarkParam trademarkParam) {
